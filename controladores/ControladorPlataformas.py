...
class ControladorPlataformas:
    ...
    def alterar_plataforma(self, nome_plataforma):
        plataforma = self.find_plataforma(nome_plataforma)
        if plataforma is None:
            return
        nova_plataforma = self.__tela_alterar.alterar_plataforma(plataforma)
        self.__dao.update(titulo=nome_plataforma, novo_titulo=nova_plataforma.titulo,
