...
class TelaDespesas(Tela):
    ...
    def abrir_menu(self):
        ...
        layout = [[sg.Text('Sobre Despesas', font=("Helvetica", 20), pad=((50, 200), (30, 30)))],
                  ...
                  [[sg.Button(button_text=('Voltar'), key=self.VOLTAR, pad=(20, 20), button_color=('white', 'red')),
    ...
    def cadastrar_despesa(self, imoveis):
        ...
        column1 = [
            ...
            [sg.Text('Imóvel associado:', font=("Helvetica", 15)),
             sg.Combo(opcoes_imoveis, key='id_imovel', size=(44, 1), readonly=True)],
            [sg.Text('Observação:', font=("Helvetica", 15)), sg.Input(key='obs', size=(52, 1))],
            [sg.Text('Data:', font=("Helvetica", 15)), sg.InputText('', key="data", size=(61, 1), disabled=True),
             sg.CalendarButton("Calendário", target="data", format="%d/%m/%Y")],
            [sg.Text('Tags:', font=("Helvetica", 15)), sg.Text('(separadas por vírgula)', font=("Helvetica", 10)),
    ...
    def exibir_despesas(self, despesas):
        ...
        dados = [[despesa.valor, despesa.imovel.titulo, despesa.obs, despesa.data, despesa.tags, despesa.id] for despesa
                 in despesas]
